            ...
            _.initials = {
                ...
                dates: {
					...
					ru: {
                        ...
                        noEventForThisDay: "В этот день не было мероприятий",
                        previousYearText: "Предыдущий год",
                        nextYearText: "Следующий год",
                        closeSidebarText: "Закрыть боковую панель",
                        closeEventListText: "Закрыть список событий"
                    },
                    kz: {
                        days: ["Жексенбі","Дүйсенбі","Сейсенбі","Сәрсенбі","Бейсенбі","Жұма","Сенбі"],
                        daysShort: ["Жек", "Дүй", "Сей", "Сәр", "Бей", "Жұм", "Сен"],
                        daysMin: ["Жк", "Дү", "Сй", "Ср", "Бс", "Жм", "Сн"],
                        months: ["Қаңтар","Ақпан","Наурыз","Сәуір","Мамыр","Маусым","Шілде","Тамыз","Қыркүйек","Қазан","Қараша","Желтоқсан"],
                        monthsShort: ["Қаң","Ақп","Нау","Сәу","Мам","Мау","Шіл","Там","Қыр","Қаз","Қар","Жел"],
                        noEventForToday: "Бүгінгі шара жоқ.",
                        noEventForThisDay: "Бұл күнге ешқандай шара жоқ",
                        previousYearText: "Өткен жыл",
                        nextYearText: "Келесі жыл",
                        closeSidebarText: "Бүйірлік тақтаны жабыңыз",
                        closeEventListText: "Оқиғалар тізімін жабыңыз"
                    },
                    es: {
